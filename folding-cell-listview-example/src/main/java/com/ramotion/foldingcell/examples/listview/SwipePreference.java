...
public class SwipePreference extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swipe_preference);
        ...
        myAppAdapter = new MyAppAdapter(array, SwipePreference.this);
    ...
    private void ifArrayEnd() {
        if(array.isEmpty()){
            ...
            final String ansPass= finalAns;
            progressDialog = new ProgressDialog(SwipePreference.this);
            progressDialog.setMessage("Give us a moment..."); // Setting Message
            progressDialog.setTitle("Fetching a surprise trip!"); // Setting Title
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    Intent intent = new Intent(getApplicationContext(), FinalItenary.class);
                    Bundle args = new Bundle();
                    args.putString("finalAns", ansPass);
...
//            viewHolder.DataText.setText(parkingList.get(position).getDescription() + "");
            ...
            Glide.with(SwipePreference.this).load(parkingList.get(position).getImagePath()).into(viewHolder.cardImage);
